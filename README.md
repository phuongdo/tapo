...
$ wget http://genoweb.toulouse.inra.fr/~pdoviet/release/bioapps.tar.gz
...
$ wget http://genoweb.toulouse.inra.fr/~pdoviet/release/tapo.rar
...
In the HOME_DIR/BioApps/ tapo-v1.1.2/conf directory. The red lines are the vital parameters.  You must modify these parameters to fit your system OS. Others are not necessary.
...
$ sh bin/run apps.TaPo "-p 2gsc -c A -nCore 1

-o /home/mchateau/work/2gscA.o"
