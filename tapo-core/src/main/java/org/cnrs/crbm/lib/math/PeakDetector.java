...
public class PeakDetector {
     ...
     * creation.
     *
     * @param windowSize the window size to look for peaks. a neighborhood of +/-
     ...
     */
    @Deprecated
    public static int[] getPeaks(List<Double> signals) {

        // convert signals to peaks signals
        double[] signals_down = new double[signals.size()];
        for (int i = 0; i < signals.size(); i++) {
            signals_down[i] = signals.get(i);
        }
...
//
//    public static int[] getBottoms(List<Double> signals) {
//
//        // convert signals to peaks signals
//        double[] signals_down = new double[signals.size()];
//        for (int i = 0; i < signals.size(); i++) {
//            signals_down[i] = 100 - signals.get(i);
//        }
//
//        PeakDetector detector = new PeakDetector(signals_down);
//
