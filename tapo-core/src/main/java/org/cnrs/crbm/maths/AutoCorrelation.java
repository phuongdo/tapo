 ...
 * <p>
 * This class presents static  autocorrelation funktions.
 *
 * @autor Christoph Lauer
 * @version 1.2
 */
public class AutoCorrelation {
     ...
     * @param  int windowlength - the length of correlation build with the summaration loop. Corresponds to lag-max
