...
import org.cnrs.crbm.maths.Complex;
 ...
 * <p>
 * A sub-class of <code>Complex</code> which generates objects that
 * represent complex phasors in terms of their amplitude, velocity
 * (in radians) and decay factor. An operation to determine the
 * position of the <code>ComplexPhasor</code> after a rotation by a
 * fraction of 2 PI is also provided.
...
public class ComplexPhasor extends Complex implements Cloneable {
    ...
    */
    ...
    /**
    Create a new phasor of unit amplitude with the given velocity
    in radians
    */
    ...
    /**
    Create a new phasor with the given amplitude and velocity in
    radians
    */
    ...
    /**
    Create a new phasor with the given amplitude, velocity in
    radians and decay factor
    */
    ...
    /**
    Rotate the phasor by the given fraction of 2 PI and place the
    new location of the phasor in the given <code>Complex</code>
    number object
    */
    public void rotate(float fraction, Complex complex) {
        double factor =
            Math.pow(Math.E, fraction * decay) * amplitude;
