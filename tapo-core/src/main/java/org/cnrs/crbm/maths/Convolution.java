...
public class Convolution extends FFT {
    ...
    /**
     * Convolve the first <code>length</code> elements of the two
     ...
     * 2 * <code>length</code> <= <code>convolution.length</code> 
    */
    public static void convolve(float[] xReals, float[] yReals,
                                Complex[] convolution, int length) {
