 ...
 * <p>
 * A sub-class of <code>FFT</code> providing a static method implementing 
...
public class Correlation extends FFT {
    ...
    /**
    Correlate the first <code>length</code> elements of the two
    purely real data sets, <code>xReals</code> and
    <code>yReals</code>, and place the results in the array 
    <code>correlation</code>.
    <P>
    Assumes <code>length</code> <= </code>xReals.length</code>,
    <code>length</code> <= <code>yReals.length</code>, and 
    2 * <code>length</code> <= <code>correlation.length</code> 
    */
    public static void correlate(float[] xReals, float[] yReals,
                                 Complex[] correlation, int length) {
