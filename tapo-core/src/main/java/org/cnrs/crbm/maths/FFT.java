 ...
 * <p>
 * The <code>FFT</code> class provides static methods supporting the
 * performance of in-place mixed-radix Fast Fourier Transforms.
 * This is an implementation and extension of a radix-2 FFT algorithm
 * in "Numerical Recipes in Pascal", W.H.Press, B.P. Flannery, 
 * S.A. Taukolsky, and W.T. Vetterling, Cambridge University Press,
 * 1989.  
...
public class FFT {
    ...
    */
    ...
    /**
    Perform an in-place mixed-radix Fast Fourier Transform on the
    first <code>n</code> elements of the given set of
    <code>Complex</code> numbers. If <code>n</code> is not a power
    of two then the FFT is performed on the first N numbers where
    N is largest power of two less than <code>n</code>  
    */
    ...
    */
    ...
    /**
       erform an in-place mixed-radix FFT (if sign is 1) or inverse
