 ...
 * <p>
 * The <code>MathsPower2</code> class contains some static methods
 * supporting useful and commonly-used mathematical operations
 * relating to powers of two and logs to the base two.
