 ...
 * <p>
 * The <code>RandomNumber</code> class creates object that provide a
 * simple random number generator, generating random numbers between
 * 0 and 1.
 * <P>
 * This is an implementation of algorithm ran2 in "Numerical Recipes
 * in Pascal", W.H.Press, B.P. Flannery, S.A. Taukolsky, and
 * W.T. Vetterling, Cambridge University Press, 1989, page 220.
