 ...
 * <p>
 * The <code>WaveletBasis</code> class creates objects that represent 
 * wavelet basis sets (sets of floating-point coefficients)
...
public class WaveletBasis {
    ...
    /**
    Create a new <code>WaveletBasis</code> object representing a
    wavelet basis set with the given name and given coefficient
    values 
    */
    ...
    /**
    Get the number of coefficients in the
