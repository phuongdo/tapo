 ...
 * <P>
 * The <code>WaveletBasisSets</code> class creates objects that
 * manage a collection of <code>WaveletBasis</code> objects and
 * record the indices of a default and current set
...
public class WaveletBasisSets {
    ...
    /**
    Create a new <code>WaveletBasisSets</code> object recording 
    information about zero <code>WaveletBasis</code> sets, with
    default and current sets of index 0 
    */
    ...
    /**
    Set the <code>WaveletBasis</code> sets held by the
    <code>WaveletBasisSets</code> object. 
    */
    ...
    */
    ...
    /**
    Set the current set to be the default
    <code>WaveletBasis</code> set 
    */
