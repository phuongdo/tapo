package org.cnrs.crbm.terminal;
...
public class ProgressBar {
	...
	private final AtomicReference<Label> label = new AtomicReference<Label>(
			Label.empty());
	...
	public static void moveCursorToBottomRight() {
		System.out.print(org.fusesource.jansi.Ansi.ansi().cursor(terminal.getHeight(),
				terminal.getWidth()));
	}
